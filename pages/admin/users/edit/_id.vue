        ...
        <b-col md="6">
          <b-card class="mt-5">
            <b-card-title class="text-center"
              >Chỉnh Sửa Người Dùng</b-card-title
            >
            <b-form @submit.prevent="confirmUpdate">
              ...
              <b-form-group>
                <b-form-radio
                  ...
                  name="changePassword"
                  value="true"
                  >Thay đổi mật khẩu</b-form-radio
                >
                <b-form-radio
                  v-model="changePassword"
                  name="changePassword"
                  value="false"
                  >Không thay đổi mật khẩu</b-form-radio
                >
              </b-form-group>
              ...
              >
                <b-form-input
                  ...
                  v-model="user.MatKhau_confirmation"
                  required
                ></b-form-input>
              </b-form-group>
    ...
    async updateUser() {
      try {
        ...
        if (this.newAvatar) {
          ...
          const response = await adminService.uploadUserAvatar(
            this.$axios,
            formData
          );
