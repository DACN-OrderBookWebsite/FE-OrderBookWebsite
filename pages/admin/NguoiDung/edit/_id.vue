        ...
        <div class="user-create-container border">
            ...
            <b-form @submit.prevent="confirmUpdate">
                ...
                <b-form-group label="Tên đăng nhập:" label-for="input-TenDangNhap">
                    <b-form-input id="input-TenDangNhap" v-model="data.TenDangNhap" required
                        placeholder="Nhập tên đăng nhập"></b-form-input>
                ...
                <b-form-group label="Địa chỉ:" label-for="input-address">
                    <b-form-input id="input-address" v-model="data.DiaChi" required
                ...
                <b-form-group label="Email:" label-for="input-email">
                    <b-form-input id="input-email" v-model="data.Email" required placeholder="Nhập Email"></b-form-input>
                ...
                <b-form-group label="Giới tính:" label-for="input-GioiTinh">
                    <b-form-select id="input-GioiTinh" v-model="data.GioiTinh" required :options="[
                        { value: 0, text: 'Nam' },
                        { value: 1, text: 'Nữ' },
                ...
                <b-form-group label="Chức vụ:" label-for="input-ChucVu">
                    <b-form-select id="input-ChucVu" v-model="data.idChucVu" required :options="ChucVuOption"
                        class="max-width-select"></b-form-select>
                ...
                <b-form-group label="Ảnh:" label-for="image-input">
                    <b-form-file id="image-input" v-model="data.Anh" accept="image/*" @change="getAnh"></b-form-file>
...
export default {
    ...
    methods: {
        ...
        async getEdit() {
            try {
                const response = await NguoiDungService.getEdit(this.$axios, this.$route.params.id);
