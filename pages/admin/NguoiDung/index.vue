        ...
        <div id="table_content">
            ...
            <b-table :items="data" :fields="fields" class="text-center">
                ...
                <template #cell(actions)="data">
                    ...
                    <b-button size="sm" variant="warning" @click="confirmResetPassword(data.item)">Đặt lại mật
                        khẩu</b-button>
                </template>
            </b-table>
        </div>
...
export default {
    ...
    methods: {
        ...
        add() {
            this.$router.push('/admin/NguoiDung/create');
        },
        edit(id) {
        ...
        async resetPassword(user) {
            try {
                ...
                await NguoiDungService.resetPassword(this.$axios, user.id, user.TenDangNhap, user.TenDangNhap);
                Swal.fire(
                    'Đã Thay Đổi!',
