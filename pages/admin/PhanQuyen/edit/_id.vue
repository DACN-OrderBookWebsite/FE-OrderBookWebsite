    ...
    <div>
        ...
        <b-container>
            <b-row class="justify-content-md-center">
                <b-col md="6">
                    <b-card class="mt-5">
                        <b-card-title class="text-center">Chỉnh Sửa Phân Quyền</b-card-title>
...
export default {
    ...
    methods: {
        ...
        async update() {
            try {
                await PhanQuyenService.update(this.$axios, this.$route.params.id, this.data);
                Swal.fire(
                    'Cập nhật!',
        ...
        async getEdit() {
            try {
                const response = await PhanQuyenService.getEdit(this.$axios, this.$route.params.id);
