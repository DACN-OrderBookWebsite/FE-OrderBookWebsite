      ...
      <a href="#" class="wishlist-link">
        <i>
          <svg xmlns="http://www.w3.org/2000/svg" width="18" height="15" viewBox="0 0 18 15" fill="none">
            <path d="M2.09256 7.64435C0.348151 5.5258 0.929619 2.34797 3.83696 1.2887C6.7443 0.229422 8.4887 2.34797 9.07017 3.40725C9.65164 2.34797 11.9775 0.229422 14.8849 1.2887C17.7922 2.34797 17.7922 5.5258 16.0478 7.64435C14.3034 9.7629 9.07017 14 9.07017 14C9.07017 14 3.83696 9.7629 2.09256 7.64435Z" stroke="#2C7ECA" stroke-linecap="round" stroke-linejoin="round"/>
          </svg>
        </i>
        YÊU THÍCH
      </a>
